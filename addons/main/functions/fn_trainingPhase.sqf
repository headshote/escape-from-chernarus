...
// Heavily guarded — spawn extra guards at airfield
if (!(_conscript getVariable ["CO_trainingGuardsSpawned", false])) then {
    [] call co_main_fnc_spawnAirfieldGuards; // 12-16 guards, watchtowers
    _conscript setVariable ["CO_trainingGuardsSpawned", true, true];
};
